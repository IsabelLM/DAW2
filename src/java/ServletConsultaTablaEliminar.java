 ...
 * @author Isabel
 */
public class ServletConsultaTablaEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stmt.executeUpdate("DELETE FROM " + eleccion + " WHERE id =" + id);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletConsultaTablaEliminar.class.getName()).log(Level.SEVERE, null, ex);
